...
from sp22_strategies import (no_testing_strategy, arrival_testing_strategy,
                             ...
                             sp22_1x_week_then_no_testing_strategy)
import plotting
...
def main(yaml_file='nominal.yaml', simple_plot=False, out_file='sp22_sim.png', **kwargs):
    ...
    scenario_family = amps.ScenarioFamily(params, yaml.safe_load(open("prior.yaml", "r")))
    ...
    if plot == 4:
        trajectories = [
            ...
            sim_test_strategy(params, sp22_1x_week_then_no_testing_strategy(params), 'black'),
        ]
